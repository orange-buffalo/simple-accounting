...
export default {
  ...
  loginPage: {
    ...
    loginError: {
      ...
      accountLocked: (lockDurationInSec: number) =>
        format('Обліковий запис тимчасово заблоковано. Він буде розблокований через {0, duration}', [
          lockDurationInSec,
        ]),
      userNotActivated: () =>
        "Ваш обліковий запис ще не активовано. Будь ласка, використовуйте токен, який вам надали адміністратори. Зв'яжіться з ними, якщо вам потрібно скинути токен",
    },
  },
  ...
  errorHandler: {
    fatalErrorMessage: () =>
      'Ми зіткнулися з технічною помилкою. Будь ласка, розгляньте можливість повідомити про проблему та оновіть сторінку, щоб спробувати знову.',
  },
  ...
  formValidationMessages: {
    sizeMinMax: (min: number, max: number) =>
      format(
        'Довжина цього значення не повинна бути коротшою за {min, number} та не довшою за {max, number} символів',
        {
          min,
          max,
        },
    ...
    sizeMax: (max: number) =>
      format('Довжина цього значення не повинна перевищувати {max, number} символів', {
        max,
      }),
  ...
  accountActivationPage: {
    ...
    instructions: () =>
      "Будь ласка, введіть ваш новий пароль. Після цього вам потрібно буде увійти, використовуючи ваше ім'я користувача та новий пароль.",
    form: {
      password: {
        label: () => 'Новий пароль',
  ...
  editUser: {
    ...
    form: {
      ...
      activationStatus: {
        ...
        loading: () => 'Завантаження...',
        notActivated: () =>
          'Обліковий запис користувача ще не активовано. Будь ласка, поділіться посиланням нижче з користувачем, щоб він міг налаштувати свій пароль.',
  ...
  saForm: {
    inputValidationFailed: () =>
      'Деякі поля не були правильно заповнені. Будь ласка, перевірте форму та спробуйте знову.',
  },
