...
export function findByIdOrEmpty<T extends HasOptionalId>(list: T[], targetItemId?: string): T | undefined {
  return list
...
export function useValueLoadedByCurrentWorkspaceAndProp<T, P>(
  ...
  valueLoader: (propValue: P, currentWorkspaceId: string) => Promise<UnwrapRef<T>>,
) {
