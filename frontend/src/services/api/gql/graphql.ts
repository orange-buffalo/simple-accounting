...
export type InvalidateRefreshTokenMutationVariables = Exact<{ [key: string]: never; }>;


export type InvalidateRefreshTokenMutation = { __typename?: 'Mutation', invalidateRefreshToken: boolean };
...
export const InvalidateRefreshTokenDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"invalidateRefreshToken"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"invalidateRefreshToken"}}]}}]} as unknown as DocumentNode<InvalidateRefreshTokenMutation, InvalidateRefreshTokenMutationVariables>;
