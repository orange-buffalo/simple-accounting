...
export type GetDashboardAnalyticsQuery = { __typename?: 'Query', workspace: { __typename?: 'Workspace', analytics: { __typename?: 'WorkspaceAnalytics', expensesSummary: { __typename?: 'ExpensesSummary', totalAmount: number, finalizedCount: number, pendingCount: number, currencyExchangeDifference: number, items: Array<{ __typename?: 'ExpensesSummaryItem', totalAmount: number, category?: { __typename?: 'Category', id: number } | null }> }, incomesSummary: { __typename?: 'IncomesSummary', totalAmount: number, finalizedCount: number, pendingCount: number, currencyExchangeDifference: number, items: Array<{ __typename?: 'IncomesSummaryItem', totalAmount: number, category?: { __typename?: 'Category', id: number } | null }> }, incomeTaxPaymentsSummary: { __typename?: 'IncomeTaxPaymentsSummary', totalTaxPayments: number } } } };

export type DashboardInvoicesQueryVariables = Exact<{
  workspaceId: Scalars['Long']['input'];
  statusIn?: InputMaybe<Array<InvoiceStatus> | InvoiceStatus>;
}>;


export type DashboardInvoicesQuery = { __typename?: 'Query', workspace: { __typename?: 'Workspace', invoices: { __typename?: 'InvoicesConnection', edges: Array<{ __typename?: 'InvoiceEdge', node: { __typename?: 'Invoice', id: number, title: string, amount: number, currency: string, dateIssued: string, dateSent?: string | null, dueDate: string, status: InvoiceStatus, customer?: { __typename?: 'Customer', id: number } | null } }> } } };
...
export type GetLinkedInvoiceForIncomeQueryVariables = Exact<{
  workspaceId: Scalars['Long']['input'];
  invoiceId: Scalars['Long']['input'];
}>;


export type GetLinkedInvoiceForIncomeQuery = { __typename?: 'Query', workspace: { __typename?: 'Workspace', invoice?: { __typename?: 'Invoice', title: string } | null } };
...
export const GetLinkedInvoiceForIncomeDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"getLinkedInvoiceForIncome"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"workspaceId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Long"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"invoiceId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Long"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"workspace"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"workspaceId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"invoice"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"invoiceId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"title"}}]}}]}}]}}]} as unknown as DocumentNode<GetLinkedInvoiceForIncomeQuery, GetLinkedInvoiceForIncomeQueryVariables>;
