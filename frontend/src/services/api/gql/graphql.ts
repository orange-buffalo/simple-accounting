...
export type GetExpensesSummaryQueryVariables = Exact<{
  workspaceId: Scalars['Long']['input'];
  fromDate: Scalars['LocalDate']['input'];
  toDate: Scalars['LocalDate']['input'];
}>;
...
export type GetExpensesSummaryQuery = { __typename?: 'Query', workspace: { __typename?: 'Workspace', analytics: { __typename?: 'WorkspaceAnalytics', expensesSummary: { __typename?: 'ExpensesSummary', totalAmount: number, finalizedCount: number, pendingCount: number, items: Array<{ __typename?: 'ExpensesSummaryItem', totalAmount: number, category?: { __typename?: 'Category', id: number } | null }> } } } };

export type GetIncomesSummaryQueryVariables = Exact<{
  workspaceId: Scalars['Long']['input'];
  fromDate: Scalars['LocalDate']['input'];
  toDate: Scalars['LocalDate']['input'];
}>;
...
export type GetIncomesSummaryQuery = { __typename?: 'Query', workspace: { __typename?: 'Workspace', analytics: { __typename?: 'WorkspaceAnalytics', incomesSummary: { __typename?: 'IncomesSummary', totalAmount: number, finalizedCount: number, pendingCount: number, items: Array<{ __typename?: 'IncomesSummaryItem', totalAmount: number, category?: { __typename?: 'Category', id: number } | null }> } } } };

export type GetProfitSummaryQueryVariables = Exact<{
  workspaceId: Scalars['Long']['input'];
  fromDate: Scalars['LocalDate']['input'];
  toDate: Scalars['LocalDate']['input'];
}>;
...
export type GetProfitSummaryQuery = { __typename?: 'Query', workspace: { __typename?: 'Workspace', analytics: { __typename?: 'WorkspaceAnalytics', expensesSummary: { __typename?: 'ExpensesSummary', totalAmount: number, currencyExchangeDifference: number }, incomesSummary: { __typename?: 'IncomesSummary', totalAmount: number, currencyExchangeDifference: number }, incomeTaxPaymentsSummary: { __typename?: 'IncomeTaxPaymentsSummary', totalTaxPayments: number } } } };
