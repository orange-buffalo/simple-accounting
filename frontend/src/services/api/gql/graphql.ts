...
/** Base interface for cursor-based paginated connections providing pagination information and total count. */
...
export type WorkspacesConnection = PaginatedConnection & {
...
export type PaginationInfoFragment = { __typename?: 'WorkspacesConnection', totalCount: number, pageInfo: { __typename?: 'PageInfo', endCursor?: string | null, hasNextPage: boolean, hasPreviousPage: boolean, startCursor?: string | null } } & { ' $fragmentName'?: 'PaginationInfoFragment' };
...
export type WorkspacesPageQuery = { __typename?: 'Query', workspaces: (
    { __typename?: 'WorkspacesConnection', edges: Array<{ __typename?: 'WorkspaceEdge', cursor: string, node: { __typename?: 'Workspace', name: string } }> }
