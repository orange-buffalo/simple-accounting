...
export type GetDashboardAnalyticsQuery = { __typename?: 'Query', workspace: { __typename?: 'Workspace', analytics: { __typename?: 'WorkspaceAnalytics', expensesSummary: { __typename?: 'ExpensesSummary', totalAmount: number, finalizedCount: number, pendingCount: number, currencyExchangeDifference: number, items: Array<{ __typename?: 'ExpensesSummaryItem', totalAmount: number, category?: { __typename?: 'Category', id: number, name: string } | null }> }, incomesSummary: { __typename?: 'IncomesSummary', totalAmount: number, finalizedCount: number, pendingCount: number, currencyExchangeDifference: number, items: Array<{ __typename?: 'IncomesSummaryItem', totalAmount: number, category?: { __typename?: 'Category', id: number, name: string } | null }> }, incomeTaxPaymentsSummary: { __typename?: 'IncomeTaxPaymentsSummary', totalTaxPayments: number } }, invoices: { __typename?: 'InvoicesConnection', edges: Array<{ __typename?: 'InvoiceEdge', node: { __typename?: 'Invoice', id: number, title: string, amount: number, currency: string, dateIssued: string, dateSent?: string | null, dueDate: string, status: InvoiceStatus, customer?: { __typename?: 'Customer', id: number, name: string } | null } }> } } };
