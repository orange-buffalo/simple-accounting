 ...
 * 
 * MANUALLY PATCHED: This file has been patched to fix timezone-dependent date serialization.
 * The generated code used toISOString().substring(0,10) which incorrectly converts dates to UTC.
 * This has been replaced with formatLocalDateToISO() which uses local timezone methods.
 * See date-utils.ts for implementation details.
 */
