...
import type { IncomesExpensesStatisticsDto, IncomeTaxPaymentsStatisticsDto } from '../models/index';
import {
...
export class StatisticsApiApi extends runtime.BaseAPI {
  /**
   */
  async getCurrenciesShortlistRaw(
    requestParameters: GetCurrenciesShortlistRequest,
    ...
    const response = await this.request(
      {
        path: `/api/workspaces/{workspaceId}/statistics/currencies-shortlist`.replace(
          `{${'workspaceId'}}`,
  ...
  /**
   */
  async getExpensesStatisticsRaw(
    requestParameters: GetExpensesStatisticsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<IncomesExpensesStatisticsDto>> {
    if (requestParameters['workspaceId'] == null) {
      throw new runtime.RequiredError(
        'workspaceId',
    ...
    const response = await this.request(
      {
        path: `/api/workspaces/{workspaceId}/statistics/expenses`.replace(
          `{${'workspaceId'}}`,
          encodeURIComponent(String(requestParameters['workspaceId'])),
        ),
        method: 'GET',
  ...
  async getExpensesStatistics(
    requestParameters: GetExpensesStatisticsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<IncomesExpensesStatisticsDto> {
  ...
  /**
   */
  async getIncomesStatisticsRaw(
    requestParameters: GetIncomesStatisticsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<IncomesExpensesStatisticsDto>> {
    if (requestParameters['workspaceId'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/api/workspaces/{workspaceId}/statistics/incomes`.replace(
          `{${'workspaceId'}}`,
          encodeURIComponent(String(requestParameters['workspaceId'])),
        ),
        method: 'GET',
  ...
  /**
   */
  async getTaxPaymentsStatisticsRaw(
    requestParameters: GetTaxPaymentsStatisticsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<IncomeTaxPaymentsStatisticsDto>> {
    if (requestParameters['workspaceId'] == null) {
      throw new runtime.RequiredError(
        'workspaceId',
    ...
    const response = await this.request(
      {
        path: `/api/workspaces/{workspaceId}/statistics/income-tax-payments`.replace(
          `{${'workspaceId'}}`,
          encodeURIComponent(String(requestParameters['workspaceId'])),
        ),
        method: 'GET',
  ...
  /**
   */
  async getTaxPaymentsStatistics(
    requestParameters: GetTaxPaymentsStatisticsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<IncomeTaxPaymentsStatisticsDto> {
