...
import type { GeneralTaxReportDto } from '../models/index';
import { GeneralTaxReportDtoFromJSON, GeneralTaxReportDtoToJSON } from '../models/index';
...
export class ReportingApiApi extends runtime.BaseAPI {
  /**
   */
  async getGeneralTaxReportRaw(
    requestParameters: GetGeneralTaxReportRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<GeneralTaxReportDto>> {
    ...
    const response = await this.request(
      {
        path: `/api/workspaces/{workspaceId}/reporting/general-taxes`.replace(
          `{${'workspaceId'}}`,
  ...
  /**
   */
  async getGeneralTaxReport(
    requestParameters: GetGeneralTaxReportRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<GeneralTaxReportDto> {
