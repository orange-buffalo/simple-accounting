...
import type { LoginRequest, TokenResponse } from '../models/index';
import { LoginRequestFromJSON, LoginRequestToJSON, TokenResponseFromJSON, TokenResponseToJSON } from '../models/index';
...
export class AuthenticationApiApi extends runtime.BaseAPI {
  ...
  /**
   */
  async loginBySharedWorkspaceTokenRaw(
    requestParameters: LoginBySharedWorkspaceTokenRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<TokenResponse>> {
  ...
  /**
   */
  async loginBySharedWorkspaceToken(
    requestParameters: LoginBySharedWorkspaceTokenRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<TokenResponse> {
