...
<script>
  ...
  export default {
    ...
    created: async function () {
      if (this.isEditing) {
        let invoiceResponse = await api.get(`/user/workspaces/${this.workspace.id}/invoices/${this.$route.params.id}`)
    ...
    methods: {
      ...
      pushInvoice: async function () {
        ...
        if (this.isEditing) {
          await api.put(`/user/workspaces/${this.workspace.id}/invoices/${this.invoice.id}`, invoiceToPush)
        } else {
          await api.post(`/user/workspaces/${this.workspace.id}/invoices`, invoiceToPush)
        }
