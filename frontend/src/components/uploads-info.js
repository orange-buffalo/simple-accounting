...
export const UploadInfo = function () {
  ...
  this.isFileSelected = () => !isNil(this.file);

  this.isEmpty = () => !this.notes && !this.isFileSelected() && !this.isDocumentUploaded();

  this.isDocumentUploaded = () => !isNil(this.document);
  ...
  this.isDocumentUploadFailed = () => this.uploadError !== null;
  ...
  this.hasNotes = () => !isNil(this.notes);
};
