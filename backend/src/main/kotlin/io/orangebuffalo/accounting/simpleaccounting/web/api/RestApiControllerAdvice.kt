...
import io.orangebuffalo.accounting.simpleaccounting.services.security.login.AccountIsTemporaryLockedException
import io.orangebuffalo.accounting.simpleaccounting.services.security.login.LoginUnavailableException
...
private fun AccountIsTemporaryLockedException.toDto() =
    AccountIsTemporaryLockedErrorDto(lockExpiresInSec = lockExpiresInSec)
