...
import io.orangebuffalo.simpleaccounting.business.api.workspaces.WorkspaceGqlDto
import io.orangebuffalo.simpleaccounting.business.api.workspaces.toWorkspaceGqlDto
...
class CreateAccessTokenByWorkspaceAccessTokenMutation(
    ...
    fun createAccessTokenByWorkspaceAccessToken(
