...
@Deprecated(message = "Use TestDataExtension")
class TestDataDeprecatedExtension : Extension, ParameterResolver, BeforeEachCallback, InvocationInterceptor {
    ...
    override fun supportsParameter(parameterContext: ParameterContext, extensionContext: ExtensionContext): Boolean {
        ...
        return !isParametrizedTest && TestDataDeprecated::class.java.isAssignableFrom(parameterContext.parameter.type)
    }
    ...
    private fun doIntercept(
        ...
        val testData = invocationContext.arguments.asSequence()
            .filter { it is TestDataDeprecated }
            .map { it as TestDataDeprecated }
            .firstOrNull()
    ...
    override fun resolveParameter(parameterContext: ParameterContext, extensionContext: ExtensionContext): Any =
        parameterContext.parameter.type.getDeclaredConstructor().newInstance() as TestDataDeprecated
}

@Deprecated(message = "Use TestData")
interface TestDataDeprecated {
