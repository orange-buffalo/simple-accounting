...
import io.orangebuffalo.simpleaccounting.tests.infra.ui.components.Checkbox
...
class CreateCategoryPage private constructor(page: Page) : SaPageBase(page) {
    ...
    val income = components.formItemByLabel("Income") { Checkbox.byContainer(it) }
    val expense = components.formItemByLabel("Expense") { Checkbox.byContainer(it) }
