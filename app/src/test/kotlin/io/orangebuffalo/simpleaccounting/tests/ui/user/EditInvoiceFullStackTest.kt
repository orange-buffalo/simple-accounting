...
import io.orangebuffalo.simpleaccounting.tests.ui.user.pages.EditInvoicePage.Companion.shouldBeEditInvoicePage
...
class EditInvoiceFullStackTest : SaFullStackTestBase() {
    ...
    fun `should handle all UI states correctly`(page: Page) {
        ...
        fun io.orangebuffalo.simpleaccounting.tests.ui.user.pages.EditInvoicePage.verifyFieldsVisibility(
